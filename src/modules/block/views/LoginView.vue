<template>
    <div
        class="top-3 right-4 z-10 fixed dark:bg-gray-700 bg-gray-200 sm:bg-transparent p-1 rounded-lg"
    >
        <switch-color-mode />
    </div>
    <div class="flex h-screen">
        <div
            class="hidden lg:flex items-center justify-center flex-1 bg-black bg-opacity-80 text-white relative"
        >
        ...
        <!-- Right Pane -->
        <div
            class="w-full bg-gray-100 dark:bg-slate-800 lg:w-1/2 flex items-center justificar-center pt-28 md:pt-0"
        >
            <div class="max-w-md w-full p-6">
                <h1
                    class="text-3xl font-semibold mb-6 text-black dark:text-white text-center"
                >
                    Regístrate
                </h1>
                <h1
                    class="text-sm font-semibold mb-6 text-gray-500 dark:text-gray-400 text-center"
                >
                    Únete a nuestra comunidad con acceso total y gratuito
                </h1>
                <div
                ...
                <form action="#" method="POST" class="space-y-4">
                    <!-- Tus elementos del formulario van aquí -->
                    <div>
                        <label
                            for="username"
                        ...
                        <input
                            ...
                            id="username"
                            name="username"
                            class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 dark:bg-white dark:text-black"
                        />
                    </div>
                    <div>
                        <label
...
<script>
import SwitchColorMode from '../../../components/SwitchColorMode.vue'
export default {
