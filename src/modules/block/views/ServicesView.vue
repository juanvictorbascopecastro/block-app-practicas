      ...
      <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
        ...
        >
          <div class="text-gray-400 flex items-center">
            ...
            <button
              type="button"
              class="ml-auto text-xs font-medium tracking-wider text-gray-400 text-gray-400 hover:text-green-400 transition ease-in duration-300"
            >
              <svg
              ...
              <div class="flex-auto sm:ml-5 justify-evenly">
                ...
                <div class="flex flex-row items-center">
                  ...
                  <div class="flex-1 inline-flex items-center ml-2 space-x-2">
                    ...
                    ></a>
                    <a hre="https://twitter.com/ajeemon?lang=en" target="_blank"
                      ><svg
          ...
          <div class="flex flex-col space-y-4">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="flex flex-col ml-3 min-w-0">
                  <span class="text-xs text-gray-500 text-right mb-1"
                    >9:02pm</span
                  >
                  <div class="flex">
                    <a
          ...
          >
            <div class="flex">
              ...
              <div class="flex flex-col justify-center w-full px-2 py-1">
                <div class="flex justify-between items-center">
                  <div class="flex flex-col">
                    <h2 class="font-medium leading-none text-gray-100">
                      Massive Dynamic
                    </h2>
                  </div>
                  <svg
