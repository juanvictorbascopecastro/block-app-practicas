        ...
        <div class="container m-4">
            <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
                    ...
                    <div class="text-gray-400 flex items-center">
                        ...
                        <p>
                            ...
                            <a
                                ...
                                class="underline hover:underline-none ml-1 text-green-300"
                                target="_blank"
                                >tailwindcomponets</a
                            >
                        </p>
                        <button
                            type="button"
                            class="ml-auto text-xs font-medium tracking-wider text-gray-400 hover:text-green-400 transition ease-in duration-300"
                        >
                            <svg
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 sm:col-span-4">
                        ...
                        >
                            ...
                            <div class="flex justify-between items-center">
                                <i
                                    class="fab fa-behance text-xl text-gray-400"
                                ></i>
                            </div>
                            <div
                                class="text-2xl text-gray-100 font-medium leading-8 mt-5"
                    ...
                    <div class="col-span-12 sm:col-span-4">
                        ...
                        >
                            ...
                            <div class="flex justify-between items-center">
                                <i
                                    class="fab fa-codepen text-xl text-gray-400"
                                ></i>
                            </div>
                            <div
                                class="text-2xl text-gray-100 font-medium leading-8 mt-5"
                ...
                <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
                    ...
                    <div
                        class="flex flex-col p-4 bg-gray-800 border-gray-800 shadow-md hover:shodow-lg rounded-2xl"
                    >
                        <div class="flex">
                            <img
                ...
                <div class="flex flex-col">
                    <div
                        class="lg:w-3/5 p-4 bg-gray-800 border-gray-800 shadow-md hover:shodow-lg rounded-2xl"
                    >
                        <div class="flex-none lg:flex">
                            <div
                                class="h-full w-full lg:h-36 lg:w-36 lg:mb-0 mb-3"
                            >
                                <img
                            ...
                            <div class="flex-auto lg:ml-3 justify-evenly py-2">
                                <div class="flex flex-col">
                                    <div
                                        class="flex items-center mr-auto text-sm"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div
                                    class="flex my-3 border-t border-gray-800"
                                ></div>
