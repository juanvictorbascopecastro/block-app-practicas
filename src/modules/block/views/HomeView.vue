            ...
            <div class="flex flex-wrap items-center mt-32">
                <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                    ...
                    >
                        ...
                        diagnóstico, así como el control de calidad de
                        alimentos, agua y sueros. Estos esfuerzos contribuyen
                        significativamente a la seguridad alimentaria y a la
                ...
                <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                    <div class="md:pr-12">
                        ...
                        >
                            ...
                            naturales. Dispone de áreas dedicadas a la
                            preparación de muestras de suelos y agua, así como
                            la realización de ensayos generales. Además, cuenta
                            con una sala de balanzas y un depósito para la
                            conservación de muestras, asegurando condiciones
                            óptimas para la investigación y el análisis
                            ambiental.
                        </p>
                    </div>
                </div>
...
export default {
    components: { HomeScreen, Contacto },
}
</script>
